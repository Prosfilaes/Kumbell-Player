...
build_from_start_kalah3:
	gnatmake -O3 -gnat2020 -march=native -mtune=native -gnata -gnatp -Wall -Isrc/ -Isrc/kalah/ -Isrc/kalah3/ build_from_start.adb -o ./build_from_start_kalah3

build_from_start_kalah2:
	gnatmake -O3 -gnat2020 -march=native -mtune=native -gnata -gnatp -Wall -Isrc/ -Isrc/kalah/ -Isrc/kalah2/ build_from_start.adb -o ./build_from_start_kalah2
